...
nrow(data1.10[complete.cases(data1.10[,c(8,9,10,51,52)]),])  #816 in data1.10.remove 743 in data1.10.remove without smoking
...
nrow(years_long.1)  #5460
nrow(mmse_long.1)   #4779
