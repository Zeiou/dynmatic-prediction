...
ggplot(data.baseline.2.rescheck,aes(agebl,rr.0))+
  geom_point()+
  geom_smooth(method = "loess",se=T)+
  ylim(c(-1.5,1.5))

ggplot(data.baseline.2.rescheck,aes(yearseducation,rr.0))+
  geom_point()+
  geom_smooth(method = "loess",se=T)+
  ylim(c(-1.5,1.5))

ggplot(data.baseline.2.rescheck,aes(mdsupdrspart3bltotalconvertedasa,rr.0))+
  geom_point()+
  geom_smooth(method = "loess",se=T)+
  ylim(c(-1.5,1.5))

ggplot(data.baseline.2.rescheck,aes(hybl,rr.0))+
  geom_point()+
  geom_smooth(method = "loess",se=T)+
  ylim(c(-1.5,1.5))
