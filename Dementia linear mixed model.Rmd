...
lme.1<-lme(mmse~ agebl+yearseducation, random = ~ followupyears | idpicc, data=data_long.2) 

lme.2<-lme(mmse~ sex+agebl+yearseducation, random = ~ followupyears | idpicc, data=data_long.2)

lme.3<-lme(mmse~ study+agebl+yearseducation, random = ~ followupyears | idpicc, data=data_long.2)

lme.4<-lme(mmse~ study*agebl+yearseducation, random = ~ followupyears | idpicc, data=data_long.2)

lme.5<-lme(mmse~ agebl+study*yearseducation, random = ~ followupyears | idpicc, data=data_long.2)

round(AIC(lme.1),2) #19799.98
AIC(lme.2) #19794.17
AIC(lme.3) #19785.5
AIC(lme.4) #19802.32
AIC(lme.5) #19791.72
