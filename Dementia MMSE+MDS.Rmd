...
# 2 patient in PICNICS without baseline and baseline information of MDS-UPDRS (censor)
# One patient (idpicc=1133) in without baseline and baseline information of MMSE and without follow-up information of MDS-UPDRS (censor)
...
lme.mds1<-lme(MDSUPDRS3~study+agebl+sex+smoking+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)

lme.mds2<-lme(MDSUPDRS3~study+agebl+sex+smoking+yearseducation+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)

#lme.mds3<-lme(MDSUPDRS3~study+agebl+sex+smoking+cognitivebl+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)

#error:nlminb problem, convergence error code = 1 message = false convergence (8)

#lme.mds4<-lme(MDSUPDRS3~study+agebl+sex+smoking+hallucinationsbl+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)

#error:nlminb problem, convergence error code = 1 message = false convergence (8)

lme.mds5<-lme(MDSUPDRS3~study+agebl+sex+smoking+yearseducation+cognitivebl+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)

lme.mds6<-lme(MDSUPDRS3~study+agebl+sex+smoking+yearseducation+hallucinationsbl+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)

lme.mds7<-lme(MDSUPDRS3~study+agebl+sex+smoking+cognitivebl+hallucinationsbl+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)

lme.mds8<-lme(MDSUPDRS3~study+agebl+sex+smoking+yearseducation+cognitivebl+hallucinationsbl+followupyears, random = ~ followupyears | idpicc, data=data_long.fit.up)


AIC(lme.mds1) #27740.5
AIC(lme.mds2) #27731.2
#AIC(lme.mds3) 
#AIC(lme.mds4) 
AIC(lme.mds5) #27718.2 
AIC(lme.mds6) #27727.4
AIC(lme.mds7) #27721.4
AIC(lme.mds8) #27714.8 #This one

BIC(lme.mds1) #27821.4
BIC(lme.mds2) #27818.2
#BIC(lme.mds3) 
#BIC(lme.mds4) 
BIC(lme.mds5) #27811.5 #This one
BIC(lme.mds6) #27820.6
BIC(lme.mds7) #27814.6
BIC(lme.mds8) #27814.3
...
Mixed1<-list(lme.mmse3,lme.mds5) 
