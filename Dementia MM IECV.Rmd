...
tvAUC(roc.pa.or.0) #0.6263
tvAUC(roc.pa.or.1) #0.6096
tvAUC(roc.pa.or.2) #0.6722
tvAUC(roc.pa.or.3) #0.6149
tvAUC(roc.pa.or.4) #0.5953
```
...
for (i in 1:2) {
  ...
  tauc_corr[i] <- tvAUC(roc.pa.or.0)$auc - tauc_opt.0[i]
}
