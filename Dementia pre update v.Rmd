...
Mixed2<-list(lme.up,lme.cog3)


jointFit.up1<-jm(baseline.cox.up1,Mixed_objects = Mixed1,time_var = "followupyears")

jointFit.up2<-jm(baseline.cox.up2,Mixed_objects = Mixed2,time_var = "followupyears")

jointFit.up3<-jm(baseline.cox.up2,Mixed_objects = Mixed1,time_var = "followupyears")

jointFit.up4<-jm(baseline.cox.up1,Mixed_objects = Mixed2,time_var = "followupyears")
